...
@section('content')
    ...
    <div style="flex: 1; display: flex; flex-direction: column; gap: 30px;">
        ...
        <div class="video-section">
            <h2>How to Order</h2>
            <iframe src="https://www.youtube.com/embed/wBzXrbcCXPA?si=H6nPD2sDtL4Bt4l1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            {{-- <iframe width="560" height="315" src="https://www.youtube.com/embed/wBzXrbcCXPA?si=H6nPD2sDtL4Bt4l1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> --}}
        </div>
    </div>
@endsection
@push('js')
